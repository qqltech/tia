    ...
    <div class="p-4 grid <md:grid-cols-1 grid-cols-3 gap-2 ">
      ...
      <div>
        <FieldSelect :bind="{ disabled: !actionText, clearable: true }" class="w-full !mt-3" :value="values.tipe_order"
          @input="v => values.tipe_order = v" :errorText="formErrors.tipe_order ? 'failed' : ''" :hints="formErrors.tipe_order"
          valueField="key" displayField="key" :options="['EKSPORT', 'IMPORT']" placeholder="Pilih Tipe" label="Tipe"
          :check="true" />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.tgl" :errorText="formErrors.tgl?'failed':''"
            @input="v=>values.tgl=v" :hints="formErrors.tgl" 
            :check="false"
            type="date"
            label="Tanggal"
      ...
      <div>
        <FieldSelect :bind="{ disabled: !actionText, clearable: true }" class="w-full !mt-3" :value="values.jenis_barang"
          @input="v => values.jenis_barang = v" :errorText="formErrors.jenis_barang ? 'failed' : ''" :hints="formErrors.jenis_barang"
          valueField="key" displayField="key" :options="['Barang A', 'Barang B']" placeholder="Pilih Jenis Barang" label="Jenis Barang"
          :check="true" />
      </div>
      <div>
        <FieldPopup 
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.tujuan_asal" :errorText="formErrors.tujuan_asal?'failed':''"
          @input="v=>values.tujuan_asal=v" :hints="formErrors.tujuan_asal" 
          :check="false"
          label="Tujuan/Asal"
          placeholder="Tuliskan Tujuan/Asal"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.moda_transportasi" :errorText="formErrors.moda_transportasi?'failed':''"
          @input="v=>values.moda_transportasi=v" :hints="formErrors.moda_transportasi" 
          :check="false"
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.coo" :errorText="formErrors.coo?'failed':''"
          @input="v=>values.coo=v" :hints="formErrors.coo" 
          :check="false"
          label="COO"
          placeholder="Tuliskan COO"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.hc" :errorText="formErrors.hc?'failed':''"
          @input="v=>values.hc=v" :hints="formErrors.hc" 
          :check="false"
          label="HC"
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.tanggal_closing_doc" :errorText="formErrors.tanggal_closing_doc?'failed':''"
            @input="v=>values.tanggal_closing_doc=v" :hints="formErrors.tanggal_closing_doc" 
            :check="false"
            type="date"
            label="Tanggal Closing Doc"
            placeholder="Pilih Tanggal Closing Doc"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.jam_closing_doc" :errorText="formErrors.jam_closing_doc?'failed':''"
            @input="v=>values.jam_closing_doc=v" :hints="formErrors.jam_closing_doc" 
            :check="false"
            type="time"
            label="Jam Closing Doc"
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            ...
            @input="v=>values.tanggal_closing_cont=v" :hints="formErrors.tanggal_closing_cont" 
            :check="false"
            type="date"
            label="Tanggal Closing Cont."
            placeholder="Pilih Tanggal Closing Cont."
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.jam_closing_cont" :errorText="formErrors.jam_closing_cont?'failed':''"
            @input="v=>values.jam_closing_cont=v" :hints="formErrors.jam_closing_cont" 
            :check="false"
            type="time"
            label="Jam Closing Cont."
            placeholder="Pilih Jam Closing Cont."
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.no_bl" :errorText="formErrors.no_bl?'failed':''"
          @input="v=>values.no_bl=v" :hints="formErrors.no_bl" 
          :check="false"
          label="No. BL"
          placeholder="Tuliskan No. BL"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.tanggal_bl" :errorText="formErrors.tanggal_bl?'failed':''"
            @input="v=>values.tanggal_bl=v" :hints="formErrors.tanggal_bl" 
            :check="false"
            type="date"
            label="Tanggal BL"
            placeholder="Pilih Tanggal BL"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.no_invoice" :errorText="formErrors.no_invoice?'failed':''"
          @input="v=>values.no_invoice=v" :hints="formErrors.no_invoice" 
          :check="false"
          label="No. Invoice"
          placeholder="Tuliskan No. Invoice"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.tanggal_invoice" :errorText="formErrors.tanggal_invoice?'failed':''"
            @input="v=>values.tanggal_invoice=v" :hints="formErrors.tanggal_invoice" 
            :check="false"
            type="date"
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.tanggal_pengkont" :errorText="formErrors.tanggal_pengkont?'failed':''"
            @input="v=>values.tanggal_pengkont=v" :hints="formErrors.tanggal_pengkont" 
            :check="false"
            type="date"
            label="Tanggal Pengkont."
            placeholder="Pilih Tanggal Pengkont."
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText , required: true}" class="w-full !mt-3"
            :value="values.tanggal_pemasukan" :errorText="formErrors.tanggal_pemasukan?'failed':''"
            @input="v=>values.tanggal_pemasukan=v" :hints="formErrors.tanggal_pemasukan" 
            :check="false"
            type="date"
      ...
      <div>
        <FieldNumber :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.jumlah_coo" :errorText="formErrors.jumlah_coo?'failed':''"
          @input="v=>values.jumlah_coo=v" :hints="formErrors.jumlah_coo" 
          :check="false"
          label="COO (Jumlah)"
          placeholder="Masukan COO (Jumlah)"
        />
      </div>
      <div>
        <FieldNumber :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.lembar_coo" :errorText="formErrors.lembar_coo?'failed':''"
          @input="v=>values.lembar_coo=v" :hints="formErrors.lembar_coo" 
          :check="false"
          label="COO Doc. Lembar"
          placeholder="Masukan COO Doc. Lembar"
        />
      </div>
      <div>
        <FieldNumber :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.jumlah_coo_ulang" :errorText="formErrors.jumlah_coo_ulang?'failed':''"
          @input="v=>values.jumlah_coo_ulang=v" :hints="formErrors.jumlah_coo_ulang" 
          :check="false"
          label="COO Ulang (Jumlah)"
          placeholder="Masukan COO Ulang (Jumlah)"
        />
      </div>
      <div>
        <FieldNumber :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.lembar_coo_ulang" :errorText="formErrors.lembar_coo_ulang?'failed':''"
          @input="v=>values.lembar_coo_ulang=v" :hints="formErrors.lembar_coo_ulang" 
          :check="false"
          label="COO Ulang Doc. Lembar"
          placeholder="Masukan COO Ulang Doc. Lembar"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.kode_pelayaran" :errorText="formErrors.kode_pelayaran?'failed':''"
          @input="v=>values.kode_pelayaran=v" :hints="formErrors.kode_pelayaran" 
          :check="false"
          label="Kode Pelayaran"
          placeholder="Tuliskan Kode Pelayaran"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.nama_pelayaran" :errorText="formErrors.nama_pelayaran?'failed':''"
          @input="v=>values.nama_pelayaran=v" :hints="formErrors.nama_pelayaran" 
          :check="false"
          label="Nama Pelayaran"
          placeholder="Tuliskan Nama Pelayaran"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.no_boking" :errorText="formErrors.no_boking?'failed':''"
          @input="v=>values.no_boking=v" :hints="formErrors.no_boking" 
          :check="false"
          label="No. Boking"
          placeholder="Tuliskan No. Boking"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.voyage" :errorText="formErrors.voyage?'failed':''"
          @input="v=>values.voyage=v" :hints="formErrors.voyage" 
          :check="false"
          label="Voyage"
          placeholder="Tuliskan Voyage"
        />
      </div>
      <div>
         <FieldSelect
          :bind="{ disabled: !actionText, clearable:true }" class="w-full !mt-3"
          :value="values.lokasi_stuffing"  @input="v=>{
            if(v){
              values.lokasi_stuffing=v
            }else{
              values.lokasi_stuffing=null
            }
          }"
          :errorText="formErrors.lokasi_stuffing?'failed':''" 
          :hints="formErrors.lokasi_stuffing"
          valueField="id" displayField="nama_lokasi"
          :api="{
          ...
          placeholder="Pilih Lokasi Stuffing" label="Lokasi Stuffing" :check="true"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.gw" :errorText="formErrors.gw?'failed':''"
          @input="v=>values.gw=v" :hints="formErrors.gw" 
          :check="false"
          label="GW"
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.nw" :errorText="formErrors.nw?'failed':''"
          @input="v=>values.nw=v" :hints="formErrors.nw" 
          :check="false"
          label="NW"
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.nama_kapal" :errorText="formErrors.nama_kapal?'failed':''"
          @input="v=>values.nama_kapal=v" :hints="formErrors.nama_kapal" 
          :check="false"
          label="Nama Kapal"
          placeholder="Tuliskan Nama Kapal"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.nama_pelabuhan" :errorText="formErrors.nama_pelabuhan?'failed':''"
          @input="v=>values.nama_pelabuhan=v" :hints="formErrors.nama_pelabuhan" 
          :check="false"
          label="Nama Pelabuhan"
          placeholder="Tuliskan Nama Pelabuhan"
        />
      </div>
      ...
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.angkutan" :errorText="formErrors.angkutan?'failed':''"
          @input="v=>values.angkutan=v" :hints="formErrors.angkutan" 
          :check="false"
          label="Angkutan"
          placeholder="Tuliskan Angkutan"
        />
      </div>
      <div>
        <FieldNumber :bind="{ readonly: !actionText }" class="w-full !mt-3" :value="values.jumlah_kemasan"
          :errorText="formErrors.jumlah_kemasan?'failed':''" @input="v=>values.jumlah_kemasan=v" :hints="formErrors.jumlah_kemasan" :check="false" label="Jml. Kemasan"
          placeholder="Masukkan Jml. Kemasan" />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
    ...
    <div class="p-4 grid <md:grid-cols-1 grid-cols-3 gap-2" v-if="activeTabIndex === 0">
      ...
      <div>
         <FieldSelect
          ...
          :errorText="formErrors.ukuran?'failed':''" 
          :hints="formErrors.ukuran"
      ...
      <div>
        <FieldNumber :bind="{ readonly: !actionText }" class="w-full !mt-3"
          :value="values.jumlah_row" :errorText="formErrors.jumlah_row?'failed':''"
          @input="v=>values.jumlah_row=v" :hints="formErrors.jumlah_row" 
          :check="false"
          label="Jumlah Baris"
          placeholder="Jumlah Baris Yang akan ditambahkan"
        />
      </div>
      <div>
              ...
              <tbody>
                <tr v-for="(item, i) in detailArr" :key="item.id" class="border-t" v-if="detailArr.length > 0">
                  ...
                  <td class="p-2 border border-[#CACACA]">
                    <FieldX :bind="{ readonly: true }" class="w-full py-2 !mt-0" :value="item.no_buku_order"
                      :errorText="formErrors.no_buku_order?'failed':''" @input="v=>item.no_buku_order=v" :hints="formErrors.no_buku_order"
                      :check="false" label="" placeholder="No. Buku Order" />
                  </td>
                  <td class="p-2 border border-[#CACACA]">
                      <FieldPopup 
                          label=""
                          ...
                          :hints="formErrors.m_petugas_pengkont_id"
                          :value="item.m_petugas_pengkont_id" @input="(v)=>item.m_petugas_pengkont_id=v"
                          :api="{
                  ...
                  <td class="p-2 border border-[#CACACA]">
                      <FieldPopup 
                          ...
                          class="w-full py-2 !mt-0"
                          valueField="id" displayField="nama"
                          :hints="formErrors.m_petugas_pemasukan_id"
                          :value="item.m_petugas_pemasukan_id" @input="(v)=>item.m_petugas_pemasukan_id=v"
                          :api="{
                            url: `${store.server.url_backend}/operation/m_kary`,
                            headers: { 'Content-Type': 'Application/json', Authorization: `${store.user.token_type} ${store.user.token}`},
                            params: {
                  ...
                  <td class="p-2 border border-[#CACACA]">
                    <FieldSelect :bind="{ disabled: !actionText, clearable:false }"
                      class="w-full py-2 !mt-0" :value="item.sektor" @input="v=>item.sektor=v"
                  ...
                  <td class="p-2 border border-[#CACACA]">
                    <FieldSelect :bind="{ disabled: !actionText, clearable:false }"
                      class="w-full py-2 !mt-0" :value="item.tipe" @input="v=>item.tipe=v"
                      :errorText="formErrors.tipe?'failed':''" :hints="formErrors.tipe" valueField="id"
                      displayField="deskripsi" :api="{          
                          url: `${store.server.url_backend}/operation/m_general`,
                          headers: { 'Content-Type': 'Application/json', Authorization: `${store.user.token_type} ${store.user.token}`},
                          params: {
                  ...
                  <td class="p-2 border border-[#CACACA]">
                    <FieldSelect :bind="{ disabled: !actionText, clearable:false }"
                      class="w-full py-2 !mt-0" :value="item.jenis" @input="v=>item.jenis=v"
                      :errorText="formErrors.jenis?'failed':''" :hints="formErrors.jenis" valueField="id"
                      displayField="deskripsi" :api="{          
                          url: `${store.server.url_backend}/operation/m_general`,
                          headers: { 'Content-Type': 'Application/json', Authorization: `${store.user.token_type} ${store.user.token}`},
                          params: {
          ...
          <table class="w-[150%] lg:w-full overflow-x-auto table-auto border border-[#CACACA] mt-4">
                ...
                <tbody>
                  <tr v-for="(itemAju, i) in detailArrAju" :key="itemAju.id" class="border-t" v-if="detailArrAju.length > 0">
                    ...
                    <td class="p-2 border border-[#CACACA]">
                      <FieldSelect :bind="{ disabled: !actionText, clearable:false }"
                        class="w-full py-2 !mt-0" :value="itemAju.m_customer_id" @input="v=>itemAju.m_customer_id=v"
                    ...
                    <td class="p-2 border border-[#CACACA]">
                      <FieldX :bind="{ readonly: true }" class="w-full py-2 !mt-0" :value="itemAju.tanggal_peb_pib"
                        :errorText="formErrors.tanggal_peb_pib?'failed':''" @input="v=>itemAju.tanggal_peb_pib=v" :hints="formErrors.tanggal_peb_pib"
                        :check="false" label="" placeholder="tgl. PEB/PIB" />
                    </td>
                    <td class="p-2 border border-[#CACACA]">
