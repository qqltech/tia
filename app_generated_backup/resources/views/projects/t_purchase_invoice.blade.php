  ...
  <div class="pt-2 pb-4 px-4 grid grid-cols-3 gap-y-2 gap-x-4 items-start">
    ...
    <div>
      <FieldPopup :bind="{ readonly: !actionText }" label="No. PO" class="w-full !mt-3" valueField="id"
        ...
        :errorText="formErrors.t_lpb_id?'failed':''" @update:valueFull="(response)=>{
        ...
        if(response == undefined) {
          ...
          data.jenis_ppn = response['t_po.ppn'] == 'INCLUDE' ? 1 : 2;
    ...
    <div>
      ...
      <FieldPopup :bind="{ readonly: true }" label="No. LPB" class="w-full !mt-3" valueField="id"
        displayField="no_lpb" :value="data.t_lpb_id" @input="(v)=>data.t_lpb_id=v"
        :errorText="formErrors.m_faktur_pajak_id?'failed':''" @update:valueFull="(response)=>{
    ...
    <div>
      <div class="grid grid-cols-2 gap-4">
        <FieldSelect class="w-full !mt-3" :bind="{ disabled: true, clearable:true }" :value="data.jenis_ppn"
          ...
          :options="[{'id' : 1 , 'key' : 'INCLUDE', 'persen': 11},{'id': 2, 'key' : 'NOT INCLUDE', 'persen': 0}]"
