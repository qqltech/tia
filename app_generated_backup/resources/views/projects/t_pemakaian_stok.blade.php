...
<div class="flex flex-col border rounded-md shadow-md md:w-full w-full p-0 bg-white border-none">
  <div class="bg-blue-500 text-white rounded-t-md py-2 px-4">
    <div class="flex items-center">
      ...
      <div>
        ...
        <p class="text-gray-100">Pengisian Tarif Premi</p>
      </div>
    </div>
  </div>
  <div class="p-4 grid <md:grid-cols-1 grid-cols-3 gap-2 ">
    <!-- START COLUMN -->
    <!-- No Pemakaian Stok Column -->
    <div>
      <FieldSelect :bind="{ disabled: true }" class="w-full !mt-3 " :value="values.no_pemakaian_stok"
        :errorText="formErrors.no_pemakaian_stok?'failed':''" @input="v=>values.no_pemakaian_stok=v"
        :hints="formErrors.no_pemakaian_stok" label="No. Pemakaian Stok" placeholder="No. Pemakaian Stok" :check="false"
        />
    </div>

    <!-- No Tarif Premi Column -->
    <div>
      <FieldX :bind="{ disabled: false }" class="w-full !mt-3 " :value="values.tanggal"
        :errorText="formErrors.tanggal?'failed':''" @input="v=>values.tanggal=v"
        :hints="formErrors.tanggal" label="DD/MM/YYYY" placeholder="DD/MM/YYYY" :check="false"
        type="date"
        />
    </div>
    ...
    <div>
      <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3" :value="values.catatan"
        ...
        label="Catatan" placeholder="Catatan" valueField="id" :check="false" type="textarea" />
    </div>
    ...
    <div>
      ...
      }" :errorText="formErrors.is_active?'failed':''" :hints="formErrors.is_active" valueField="id" displayField="key"
        :options="[{'id' : 1 , 'key' : 'Active'},{'id': 0, 'key' : 'InActive'}]" placeholder="Pilih Status"
        label="Status" :check="false" />
    </div>
  ...
  <!-- detail -->
    <div class="p-4">
      <h1 class="font-bold text-xl pb-2"> Pemakaian Stok Setail </h1>
