...
<div class="flex flex-col border rounded-md shadow-md md:w-full w-full bg-white border-none">
  ...
  <div class="p-4 grid <md:grid-cols-1 grid-cols-3 gap-2 ">
    ...
    <div>
      <FieldX :bind="{ readonly: true }" class="w-full !mt-3" :value="data.no_bll" :errorText="formErrors.no_bll?'failed':''"
        @input="v=>data.no_bll=v" :hints="formErrors.no_bll" label="No. BLL" placeholder="No. BLL" :check="false" />
    </div>
    <div>
