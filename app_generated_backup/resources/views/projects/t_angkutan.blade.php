  ...
  <div class="flex flex-col border rounded-md shadow-md md:w-full w-full p-0 bg-white border-none">
    ...
    <div class="p-4 mb-2">
      ...
      <div style="overflow-x: auto; width: 1100px; border: 1px solid #CACACA;">
        <table class="w-[200%] table-auto border border-[#CACACA]">
          <thead>
            <tr class="border">
              <td
          ...
          <tbody>
            <tr v-for="(item, i) in detailArr" :key="item.id" class="border-t" v-if="detailArr.length">
              ...
              <td class="p-2 border border-[#CACACA]">
                <FieldX :bind="{ readonly: true, disabled: item.item_no_spk === null ? false : (item.no_spk ? !item.no_spk.includes('Luar') : true), required: false}" class="w-full !mt-3"
              ...
              <td class="p-2 border border-[#CACACA]">
                <FieldNumber :bind="{ readonly: item.item_no_spk === null ? false : (item.no_spk ? !item.no_spk.includes('Luar') : true) }" class="w-full !mt-3" :value="item.total_sangu"
                  :errorText="formErrors.total_sangu?'failed':''" @input="v=>item.total_sangu=v" :hints="formErrors.total_sangu"
                  :check="false" label="" placeholder="" />
              </td>
              <td class="p-2 border border-[#CACACA]">
                <FieldSelect
