...
class tcreditnote extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->integer('supplier')->comment('{"src":"m_supplier.id"}');
            $table->integer('perkiraan_credit')->comment('{"src":"set.m_general.id"}')->nullable();
            $table->decimal('total_credit_note',18,4);
