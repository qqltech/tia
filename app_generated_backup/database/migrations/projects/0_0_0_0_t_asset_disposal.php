...
class tassetdisposal extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->string('tipe_disposal');
            $table->integer('m_customer_id')->comment('{"src":"m_customer.id"}');
            $table->integer('m_asset_id')->comment('{"src":"m_asset.id"}');
            $table->string('tipe_asset');
            $table->string('perkiraan_disposal');
            $table->decimal('nilai_jual');
            $table->string('tipe_ppn');
            $table->decimal('nominal_ppn');
            $table->date('tanggal');
