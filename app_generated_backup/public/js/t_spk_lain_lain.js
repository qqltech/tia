...
const table = reactive({
  api: {
    ...
    params: {
      simplest: true,
      searchfield: 'this.no_spk, this.kode, this.lokasi_stuffing, this.sangu_tia, this.sangu_free, this.status, this.tarif_genzet, this.ganti_solar_sangu, this.ganti_solar_tag, this.kilometer',
    },
    onsuccess(response) {
