...
const table = reactive({
    api: {
        ...
        params: {
            simplest: true,
            searchfield: `this.id, this.no_draft, this.no_ppjk, t_buku_order.no_buku_order, this.no_ppjk, m_customer.nama_perusahaan, 
    ...
    columns: [
        ...
        {
            headerName: 'No PPJK', field: 'no_ppjk', flex: 1, cellClass: ['border-r', '!border-gray-200', 'justify-start'],
            sortable: true, filter: 'ColFilter'
        },
        {
