...
// ------------------------------ PERSIAPAN
const endpointApi = 'm_users_d'
onBeforeMount(()=>{
  document.title = 'm_users_d'
})
...
async function onSave() {
  //values.tags = JSON.stringify(values.tags)
    try {
      ...
      // set ke table detail
      values.m_coba_9_det = detailArr.value
...
const landing = reactive({
  ...
  api: {
    ...
    params: {
      simplest: true,
      searchfield: 'this.name_short, this.name_long, this.price, this.desc'
    },
    onsuccess(response) {
