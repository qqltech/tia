...
class t_memo_jurnal extends \App\Models\BasicModels\t_memo_jurnal
{    
    private $helper;
    private $approval;
    ...
    public function createBefore($model, $arrayData, $metaData, $id = null)
    {
        ...
        $newData = [
            "no_draft" => $this->helper->generateNomor("Draft Memo"),
            "no_memo" => $this->helper->generateNomor("Kode Memo"),
            "status" => $status,
        ];
    ...
    {
        $tempId = $id;
        $trx = \DB::table('t_memo_jurnal')->find($tempId);
        $conf = [
            "app_name" => "APPROVAL MEMO JURNAL",
            "trx_id" => $trx->id,
            "trx_table" => $this->getTable(),
            "trx_name" => "Pengajuan Memo Jurnal",
            "form_name" => "t_memo_jurnal",
            "trx_nomor" => $trx->no_memo,
            "trx_date" => Date("Y-m-d"),
