...
{   
    ...
    protected $fillable = ["no_bkk","no_draft","status","tipe_bkk","t_buku_order_id","m_business_unit_id","tanggal","m_coa_id","total_amt","tipe_pembayaran","m_akun_pembayaran_id","m_akun_bank_id","keterangan","creator_id","last_editor_id","deleted_id","deleted_at"];

    public $columns     = ["id","no_bkk","no_draft","status","tipe_bkk","t_buku_order_id","m_business_unit_id","tanggal","m_coa_id","total_amt","tipe_pembayaran","m_akun_pembayaran_id","m_akun_bank_id","keterangan","creator_id","last_editor_id","deleted_id","deleted_at","created_at","updated_at"];
    ...
    public $createable  = ["no_bkk","no_draft","status","tipe_bkk","t_buku_order_id","m_business_unit_id","tanggal","m_coa_id","total_amt","tipe_pembayaran","m_akun_pembayaran_id","m_akun_bank_id","keterangan","creator_id","last_editor_id","deleted_id","deleted_at"];
    public $updateable  = ["no_bkk","no_draft","status","tipe_bkk","t_buku_order_id","m_business_unit_id","tanggal","m_coa_id","total_amt","tipe_pembayaran","m_akun_pembayaran_id","m_akun_bank_id","keterangan","creator_id","last_editor_id","deleted_id","deleted_at"];
    public $searchable  = ["id","no_bkk","no_draft","status","tipe_bkk","t_buku_order_id","m_business_unit_id","tanggal","m_coa_id","total_amt","tipe_pembayaran","m_akun_pembayaran_id","m_akun_bank_id","keterangan","creator_id","last_editor_id","deleted_id","deleted_at","created_at","updated_at"];
