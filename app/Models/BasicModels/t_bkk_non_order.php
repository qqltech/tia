...
{   
    ...
    protected $fillable = ["no_draft","no_bkk","status","tanggal","total_amt","no_reference","keterangan","m_perkiraan_id","tipe_bkk","m_business_unit_id","m_akun_bank_id","tipe_pembayaran","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","nama_penerima"];

    public $columns     = ["id","no_draft","no_bkk","status","tanggal","total_amt","no_reference","keterangan","m_perkiraan_id","tipe_bkk","m_business_unit_id","m_akun_bank_id","tipe_pembayaran","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","created_at","updated_at","nama_penerima"];
    public $columnsFull = ["id:bigint","no_draft:string:20","no_bkk:string:20","status:string:20","tanggal:date","total_amt:decimal","no_reference:string:50","keterangan:text","m_perkiraan_id:integer","tipe_bkk:string:30","m_business_unit_id:integer","m_akun_bank_id:integer","tipe_pembayaran:integer","creator_id:integer","last_editor_id:integer","edited_at:datetime","deletor_id:integer","deleted_at:datetime","created_at:datetime","updated_at:datetime","nama_penerima:string:100"];
    public $rules       = [];
    ...
    public $createable  = ["no_draft","no_bkk","status","tanggal","total_amt","no_reference","keterangan","m_perkiraan_id","tipe_bkk","m_business_unit_id","m_akun_bank_id","tipe_pembayaran","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","nama_penerima"];
    public $updateable  = ["no_draft","no_bkk","status","tanggal","total_amt","no_reference","keterangan","m_perkiraan_id","tipe_bkk","m_business_unit_id","m_akun_bank_id","tipe_pembayaran","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","nama_penerima"];
    public $searchable  = ["id","no_draft","no_bkk","status","tanggal","total_amt","no_reference","keterangan","m_perkiraan_id","tipe_bkk","m_business_unit_id","m_akun_bank_id","tipe_pembayaran","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","created_at","updated_at","nama_penerima"];
