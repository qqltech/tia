...
{   
    ...
    protected $fillable = ["no_draft","status","tanggal","no_pi","t_po_id","no_faktur_pajak","m_supplier_id","t_lpb_id","jenis_ppn","persen_ppn","jenis_pph","persen_pph","catatan","total_pph","total_ppn","grand_total","creator_id","last_editor_id","deleted_id","deleted_at","utang","tipe_pembayaran_id","filter_tahun"];

    public $columns     = ["id","no_draft","status","tanggal","no_pi","t_po_id","no_faktur_pajak","m_supplier_id","t_lpb_id","jenis_ppn","persen_ppn","jenis_pph","persen_pph","catatan","total_pph","total_ppn","grand_total","creator_id","last_editor_id","deleted_id","deleted_at","created_at","updated_at","utang","tipe_pembayaran_id","filter_tahun"];
    public $columnsFull = ["id:bigint","no_draft:string:20","status:string:20","tanggal:date","no_pi:string:20","t_po_id:integer","no_faktur_pajak:string:255","m_supplier_id:integer","t_lpb_id:integer","jenis_ppn:integer","persen_ppn:float","jenis_pph:integer","persen_pph:float","catatan:text","total_pph:decimal","total_ppn:decimal","grand_total:decimal","creator_id:integer","last_editor_id:integer","deleted_id:integer","deleted_at:datetime","created_at:datetime","updated_at:datetime","utang:decimal","tipe_pembayaran_id:integer","filter_tahun:date"];
    public $rules       = [];
    ...
    public $heirs       = ["t_pembayaran_hutang_d","t_rencana_pembayaran_hutang_d","t_debit_note_d","t_credit_note_d","t_sub_credit_note","t_sub_debit_note"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
    ...
    public $createable  = ["no_draft","status","tanggal","no_pi","t_po_id","no_faktur_pajak","m_supplier_id","t_lpb_id","jenis_ppn","persen_ppn","jenis_pph","persen_pph","catatan","total_pph","total_ppn","grand_total","creator_id","last_editor_id","deleted_id","deleted_at","utang","tipe_pembayaran_id","filter_tahun"];
    public $updateable  = ["no_draft","status","tanggal","no_pi","t_po_id","no_faktur_pajak","m_supplier_id","t_lpb_id","jenis_ppn","persen_ppn","jenis_pph","persen_pph","catatan","total_pph","total_ppn","grand_total","creator_id","last_editor_id","deleted_id","deleted_at","utang","tipe_pembayaran_id","filter_tahun"];
    public $searchable  = ["id","no_draft","status","tanggal","no_pi","t_po_id","no_faktur_pajak","m_supplier_id","t_lpb_id","jenis_ppn","persen_ppn","jenis_pph","persen_pph","catatan","total_pph","total_ppn","grand_total","creator_id","last_editor_id","deleted_id","deleted_at","created_at","updated_at","utang","tipe_pembayaran_id","filter_tahun"];
