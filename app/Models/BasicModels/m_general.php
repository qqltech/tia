...
{   
    ...
    public $joins       = [];
    public $details     = [];
    public $heirs       = ["t_purchase_invoice","t_purchase_invoice","t_angkutan_d","t_angkutan_d","t_angkutan_d","t_angkutan_d","set.m_kary","m_supplier","m_supplier","m_supplier","m_supplier","m_item","t_buku_order","t_buku_order","t_buku_order","t_buku_order","t_purchase_order","t_purchase_order","m_customer","m_customer","t_surat_jalan","t_rencana_pembayaran_hutang_d","m_customer_d_nama","m_tarif_premi","m_tarif_premi","m_tarif_premi","m_tarif_premi","m_tarif_premi","m_tarif","m_tarif","t_spk_lain","m_tarif_angkutan","m_tarif_angkutan","m_tarif_angkutan","m_tarif_angkutan","t_credit_note","t_buku_order_d_npwp","t_buku_order_d_npwp","t_buku_order_d_npwp","t_buku_order_d_npwp","t_tagihan_d_npwp","t_tagihan_d_npwp","t_tagihan_d_npwp","t_tagihan_d_npwp","m_interface","m_interface","m_interface","m_interface","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_spk_angkutan","t_pembayaran_piutang","t_debit_note","m_tarif_komisi","m_tarif_d_lain_lain","t_nota_rampung","t_nota_rampung","t_nota_rampung","t_nota_rampung","t_pembayaran_hutang","t_pembayaran_piutang_d","t_jurnal_angkutan_d","t_jurnal_angkutan_d","t_jurnal_angkutan_d","t_jurnal_angkutan_d","m_coa","m_coa","m_coa","t_memo_jurnal","t_dp_penjualan","t_sub_debit_note","t_sub_credit_note","t_confirm_asset","t_bkk","m_tarif_nota_rampung","m_tarif_nota_rampung","m_tarif_nota_rampung","t_nota_rampung_d","t_nota_rampung_d","t_bkk_non_order","t_bkm","t_bkm_non_order"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
