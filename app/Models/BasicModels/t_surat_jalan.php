...
{   
    ...
    public $columnsFull = ["id:bigint","no_draft:string:40","no_surat_jalan:string:40","t_buku_order_id:integer","tanggal:date","tanggal_berangkat:date","status:string:191","tipe_surat_jalan:string:191","pelabuhan:string:191","kapal:string:191","catatan:text","creator_id:integer","last_editor_id:integer","edited_at:datetime","deletor_id:integer","deleted_at:datetime","created_at:datetime","updated_at:datetime","foto_berkas:string:191","lokasi_stuffing:string:191","depo:string:191","t_buku_order_d_npwp_id:integer","jenis_kontainer:string:191","ukuran_kontainer:integer","jenis_sj:integer","is_edit_berkas:boolean","nw:string:191","gw:string:191","no_seal:string:191","tare:string:191","foto_surat_jalan:string:191","jumlah_print:bigint"];
    public $rules       = [];
