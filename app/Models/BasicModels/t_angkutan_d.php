...
{   
    ...
    protected $fillable = ["t_angkutan_id","t_spk_id","depo","sektor","head","trip","tanggal_out","jam_out","tanggal_in","jam_in","free","tarif_los_cargo","nama_angkutan_id","staple","no_container","biaya_lain_lain","tgl_stuffing","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","no_angkutan","pelabuhan","waktu_out","waktu_in","angkutan_pelabuhan","ukuran","staple_akhir"];

    public $columns     = ["id","t_angkutan_id","t_spk_id","depo","sektor","head","trip","tanggal_out","jam_out","tanggal_in","jam_in","free","tarif_los_cargo","nama_angkutan_id","staple","no_container","biaya_lain_lain","tgl_stuffing","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","created_at","updated_at","no_angkutan","pelabuhan","waktu_out","waktu_in","angkutan_pelabuhan","ukuran","staple_akhir"];
    public $columnsFull = ["id:bigint","t_angkutan_id:integer","t_spk_id:integer","depo:integer","sektor:integer","head:integer","trip:integer","tanggal_out:date","jam_out:time","tanggal_in:date","jam_in:time","free:integer","tarif_los_cargo:decimal","nama_angkutan_id:integer","staple:integer","no_container:string:191","biaya_lain_lain:decimal","tgl_stuffing:date","catatan:text","creator_id:integer","last_editor_id:integer","edited_at:datetime","deletor_id:integer","deleted_at:datetime","created_at:datetime","updated_at:datetime","no_angkutan:string:191","pelabuhan:bigint","waktu_out:bigint","waktu_in:bigint","angkutan_pelabuhan:integer","ukuran:integer","staple_akhir:integer"];
    public $rules       = [];
    public $joins       = ["t_angkutan.id=t_angkutan_d.t_angkutan_id","t_spk_angkutan.id=t_angkutan_d.t_spk_id","set.m_general.id=t_angkutan_d.depo","set.m_general.id=t_angkutan_d.sektor","set.m_general.id=t_angkutan_d.head","set.m_general.id=t_angkutan_d.trip","m_supplier.id=t_angkutan_d.nama_angkutan_id","set.m_general.id=t_angkutan_d.pelabuhan","set.m_general.id=t_angkutan_d.waktu_out","set.m_general.id=t_angkutan_d.waktu_in","m_supplier.id=t_angkutan_d.angkutan_pelabuhan","set.m_general.id=t_angkutan_d.ukuran"];
    public $details     = [];
    public $heirs       = [];
    public $detailsChild= [];
    public $detailsHeirs= [];
