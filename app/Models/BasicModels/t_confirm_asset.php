...
{   
    ...
    protected $fillable = ["t_lpb_id","pic","tgl_asset","masa_manfaat","m_item_id","m_perkiraan_akun_penyusutan","kategori_id","m_perkiraan_asset_id","m_perkiraan_by_akun_penyusutan","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at"];

    public $columns     = ["id","t_lpb_id","pic","tgl_asset","masa_manfaat","m_item_id","m_perkiraan_akun_penyusutan","kategori_id","m_perkiraan_asset_id","m_perkiraan_by_akun_penyusutan","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","created_at","updated_at"];
    ...
    public $detailsHeirs= [];
    public $unique      = [];
    public $required    = ["t_lpb_id","pic","tgl_asset","masa_manfaat","m_item_id","m_perkiraan_akun_penyusutan","kategori_id","m_perkiraan_asset_id","m_perkiraan_by_akun_penyusutan"];
    public $createable  = ["t_lpb_id","pic","tgl_asset","masa_manfaat","m_item_id","m_perkiraan_akun_penyusutan","kategori_id","m_perkiraan_asset_id","m_perkiraan_by_akun_penyusutan","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at"];
    public $updateable  = ["t_lpb_id","pic","tgl_asset","masa_manfaat","m_item_id","m_perkiraan_akun_penyusutan","kategori_id","m_perkiraan_asset_id","m_perkiraan_by_akun_penyusutan","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at"];
    public $searchable  = ["id","t_lpb_id","pic","tgl_asset","masa_manfaat","m_item_id","m_perkiraan_akun_penyusutan","kategori_id","m_perkiraan_asset_id","m_perkiraan_by_akun_penyusutan","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","created_at","updated_at"];
