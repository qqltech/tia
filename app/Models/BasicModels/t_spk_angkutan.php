...
{   
    ...
    protected $fillable = ["no_spk","tipe_spk","status","t_buku_order_1_id","t_detail_npwp_container_1_id","isi_container_1","no_container_1","t_buku_order_2_id","t_detail_npwp_container_2_id","isi_container_2","no_container_2","tanggal_spk","supir","sektor1","head","chasis","dari","ke","sangu","tanggal_out","tanggal_in","catatan","creator_id","last_editor_id","delete_id","deleted_at","total_sangu","depo","m_supplier_id","trip_id","sektor2","is_con_edit","chasis2","nama_customer","nama_customer_2","waktu_out","waktu_in","jumlah_print","is_printed","filter_tahun"];

    public $columns     = ["id","no_spk","tipe_spk","status","t_buku_order_1_id","t_detail_npwp_container_1_id","isi_container_1","no_container_1","t_buku_order_2_id","t_detail_npwp_container_2_id","isi_container_2","no_container_2","tanggal_spk","supir","sektor1","head","chasis","dari","ke","sangu","tanggal_out","tanggal_in","catatan","creator_id","last_editor_id","delete_id","deleted_at","created_at","updated_at","total_sangu","depo","m_supplier_id","trip_id","sektor2","is_con_edit","chasis2","nama_customer","nama_customer_2","waktu_out","waktu_in","jumlah_print","is_printed","filter_tahun"];
    public $columnsFull = ["id:bigint","no_spk:string:50","tipe_spk:integer","status:string:191","t_buku_order_1_id:integer","t_detail_npwp_container_1_id:integer","isi_container_1:integer","no_container_1:string:191","t_buku_order_2_id:integer","t_detail_npwp_container_2_id:integer","isi_container_2:integer","no_container_2:string:191","tanggal_spk:date","supir:integer","sektor1:integer","head:integer","chasis:integer","dari:string:100","ke:string:100","sangu:decimal","tanggal_out:date","tanggal_in:date","catatan:text","creator_id:integer","last_editor_id:integer","delete_id:integer","deleted_at:datetime","created_at:datetime","updated_at:datetime","total_sangu:decimal","depo:integer","m_supplier_id:integer","trip_id:integer","sektor2:integer","is_con_edit:boolean","chasis2:integer","nama_customer:bigint","nama_customer_2:bigint","waktu_out:bigint","waktu_in:bigint","jumlah_print:bigint","is_printed:boolean","filter_tahun:date"];
    public $rules       = [];
    ...
    public $heirs       = ["t_premi","t_angkutan_d","t_ganti_solar"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
    public $required    = [""];
