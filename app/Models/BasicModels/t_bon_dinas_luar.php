...
{   
    ...
    public $rules       = [];
    public $joins       = ["m_gen.id=t_bon_dinas_luar.tipe_order_id","m_coa.id=t_bon_dinas_luar.tipe_kategori_id","t_bkk.id=t_bon_dinas_luar.t_bkk_id","set.m_kary.id=t_bon_dinas_luar.m_kary_id","m_supplier.id=t_bon_dinas_luar.m_supplier_id"];
