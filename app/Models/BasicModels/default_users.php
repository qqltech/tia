...
{   
    ...
    public $heirs       = ["t_tutup_buku","t_tutup_buku","generate_num_log","generate_num_log","generate_num_det","generate_num_det","set.generate_approval","set.generate_approval","set.generate_approval","set.generate_approval_det","set.generate_approval_det","set.generate_approval_det","set.generate_approval_det","set.generate_approval_log","set.generate_approval_log","set.generate_approval_log","set.m_approval_det","set.m_approval_det","set.m_approval_det","set.m_role_access","generate_num","generate_num","generate_num_type","generate_num_type"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [
