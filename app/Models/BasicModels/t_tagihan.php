...
{   
    ...
    protected $fillable = ["no_draft","no_tagihan","no_buku_order","customer","status","tgl","tipe_tagihan","total_amount","ppn","grand_total_amount","catatan","creator_id","last_editor_id","delete_id","delete_at","grand_total","total_kontainer","total_lain","total_ppn","total_setelah_ppn","total_tarif_jasa","piutang","no_faktur_pajak","tgl_nota","total_jasa_cont_ppjk","total_lain2_ppn","total_jasa_angkutan","total_lain_non_ppn","persentase_konsolidator_kont","filter_tahun","total_tarif_dp"];

    public $columns     = ["id","no_draft","no_tagihan","no_buku_order","customer","status","tgl","tipe_tagihan","total_amount","ppn","grand_total_amount","catatan","creator_id","last_editor_id","delete_id","delete_at","created_at","updated_at","grand_total","total_kontainer","total_lain","total_ppn","total_setelah_ppn","total_tarif_jasa","piutang","no_faktur_pajak","tgl_nota","total_jasa_cont_ppjk","total_lain2_ppn","total_jasa_angkutan","total_lain_non_ppn","persentase_konsolidator_kont","filter_tahun","total_tarif_dp"];
    ...
    public $heirs       = ["t_debit_note_d","t_credit_note_d","t_sub_credit_note","t_sub_debit_note","t_pembayaran_piutang_d"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
