...
{   
    ...
    protected $fillable = ["no_draft","no_tagihan","no_buku_order","customer","status","tgl","tipe_tagihan","total_amount","ppn","grand_total_amount","catatan","creator_id","last_editor_id","delete_id","deleted_at","grand_total","total_kontainer","total_lain","total_ppn","total_setelah_ppn","total_tarif_jasa","piutang","no_faktur_pajak","tgl_nota","total_jasa_cont_ppjk","total_lain2_ppn","total_jasa_angkutan","total_lain_non_ppn","persentase_konsolidator_kont","filter_tahun","total_tarif_dp"];

    public $columns     = ["id","no_draft","no_tagihan","no_buku_order","customer","status","tgl","tipe_tagihan","total_amount","ppn","grand_total_amount","catatan","creator_id","last_editor_id","delete_id","deleted_at","created_at","updated_at","grand_total","total_kontainer","total_lain","total_ppn","total_setelah_ppn","total_tarif_jasa","piutang","no_faktur_pajak","tgl_nota","total_jasa_cont_ppjk","total_lain2_ppn","total_jasa_angkutan","total_lain_non_ppn","persentase_konsolidator_kont","filter_tahun","total_tarif_dp"];
    public $columnsFull = ["id:bigint","no_draft:string:191","no_tagihan:string:191","no_buku_order:integer","customer:integer","status:string:10","tgl:date","tipe_tagihan:string:191","total_amount:decimal","ppn:decimal","grand_total_amount:decimal","catatan:text","creator_id:integer","last_editor_id:integer","delete_id:integer","deleted_at:datetime","created_at:datetime","updated_at:datetime","grand_total:decimal","total_kontainer:decimal","total_lain:decimal","total_ppn:decimal","total_setelah_ppn:decimal","total_tarif_jasa:decimal","piutang:decimal","no_faktur_pajak:string:191","tgl_nota:date","total_jasa_cont_ppjk:decimal","total_lain2_ppn:decimal","total_jasa_angkutan:decimal","total_lain_non_ppn:decimal","persentase_konsolidator_kont:decimal","filter_tahun:date","total_tarif_dp:decimal"];
    public $rules       = [];
    public $joins       = ["t_buku_order.id=t_tagihan.no_buku_order","m_customer.id=t_tagihan.customer"];
    public $details     = ["t_tagihan_d_tarif","t_tagihan_d_npwp","t_tagihan_d_lain"];
    public $heirs       = ["t_sub_credit_note","t_sub_debit_note","t_debit_note_d","t_credit_note_d","t_pembayaran_piutang_d"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
    public $required    = ["no_buku_order","customer","status","tgl","ppn","grand_total_amount"];
