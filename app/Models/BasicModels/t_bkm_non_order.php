...
{   
    ...
    protected $fillable = ["no_draft","no_bkm","status","t_buku_order_id","tanggal","m_akun_pembayaran_id","m_business_unit_id","tipe_pembayaran","m_akun_bank_id","total_amt","no_ref","keterangan","creator_id","last_editor_id","delete_id","delete_at","nama_penerima"];

    public $columns     = ["id","no_draft","no_bkm","status","t_buku_order_id","tanggal","m_akun_pembayaran_id","m_business_unit_id","tipe_pembayaran","m_akun_bank_id","total_amt","no_ref","keterangan","creator_id","last_editor_id","delete_id","delete_at","created_at","updated_at","nama_penerima"];
    public $columnsFull = ["id:bigint","no_draft:string:20","no_bkm:string:20","status:string:10","t_buku_order_id:integer","tanggal:date","m_akun_pembayaran_id:integer","m_business_unit_id:integer","tipe_pembayaran:integer","m_akun_bank_id:integer","total_amt:decimal","no_ref:string:20","keterangan:text","creator_id:integer","last_editor_id:integer","delete_id:integer","delete_at:datetime","created_at:datetime","updated_at:datetime","nama_penerima:string:100"];
    public $rules       = [];
    ...
    public $createable  = ["no_draft","no_bkm","status","t_buku_order_id","tanggal","m_akun_pembayaran_id","m_business_unit_id","tipe_pembayaran","m_akun_bank_id","total_amt","no_ref","keterangan","creator_id","last_editor_id","delete_id","delete_at","nama_penerima"];
    public $updateable  = ["no_draft","no_bkm","status","t_buku_order_id","tanggal","m_akun_pembayaran_id","m_business_unit_id","tipe_pembayaran","m_akun_bank_id","total_amt","no_ref","keterangan","creator_id","last_editor_id","delete_id","delete_at","nama_penerima"];
    public $searchable  = ["id","no_draft","no_bkm","status","t_buku_order_id","tanggal","m_akun_pembayaran_id","m_business_unit_id","tipe_pembayaran","m_akun_bank_id","total_amt","no_ref","keterangan","creator_id","last_editor_id","delete_id","delete_at","created_at","updated_at","nama_penerima"];
