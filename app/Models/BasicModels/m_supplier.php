...
{   
    ...
    public $details     = [];
    public $heirs       = ["t_pembayaran_hutang","t_rencana_pembayaran_hutang_d","m_tarif_angkutan","m_asset_d","t_angkutan_d","t_angkutan_d","t_credit_note","t_bon_dinas_luar","t_debit_note","t_purchase_order","t_jurnal_angkutan_d","t_jurnal_angkutan_d","t_spk_angkutan","t_jurnal_angkutan","t_lpb","temp_t_spk_angkutan","t_spk_lain","t_purchase_invoice"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [
