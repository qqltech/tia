...
{   
    ...
    public $details     = [];
    public $heirs       = ["t_lpb","t_purchase_invoice","t_angkutan_d","t_purchase_order","t_rencana_pembayaran_hutang_d","m_asset_d","m_tarif_angkutan","t_credit_note","t_spk_angkutan","t_debit_note","t_bon_dinas_luar","t_jurnal_angkutan","t_pembayaran_hutang","t_jurnal_angkutan_d","t_jurnal_angkutan_d"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [
