...
{   
    ...
    public $details     = [];
    public $heirs       = ["m_asset_d","m_tarif_angkutan","t_bon_dinas_luar","t_debit_note","t_jurnal_angkutan","t_jurnal_angkutan_d","t_jurnal_angkutan_d","t_lpb","t_credit_note","t_purchase_invoice","t_purchase_order","t_pembayaran_hutang","t_rencana_pembayaran_hutang_d","t_spk_angkutan","t_spk_lain","t_angkutan_d","t_angkutan_d"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [
