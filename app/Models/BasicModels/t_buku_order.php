...
{   
    ...
    public $details     = ["t_buku_order_detber","t_buku_order_d_npwp","t_buku_order_d_aju"];
    public $heirs       = ["t_bkk_d","t_angkutan","t_bkm_non_order","t_bkm_d","t_bon_dinas_luar_d","t_bll","t_buku_penyesuaian","t_tagihan_d_npwp","t_komisi_d","t_komisi_undername","t_spk_angkutan","t_spk_angkutan","t_komisi","t_komisi","t_nota_rampung","t_dp_penjualan","t_tagihan_lain_lain","temp_t_spk_angkutan","temp_t_spk_angkutan","t_spk_lain","t_tagihan","t_surat_jalan","t_ppjk"];
    public $detailsChild= [];
    public $detailsHeirs= ["t_nota_rampung_d","t_spk_angkutan","t_spk_angkutan","temp_t_spk_angkutan","temp_t_spk_angkutan","t_spk_lain","t_surat_jalan"];
    public $unique      = [];
    public $required    = [""];
