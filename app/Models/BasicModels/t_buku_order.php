...
{   
    ...
    public $heirs       = ["t_angkutan","t_bon_dinas_luar_d","t_ppjk","t_surat_jalan","t_komisi","t_komisi","t_komisi_d","t_tagihan_d_npwp","t_spk_angkutan","t_spk_angkutan","t_bkk_d","t_bll","t_nota_rampung","t_bkm_d","t_komisi_undername","t_buku_penyesuaian","t_dp_penjualan","t_tagihan_lain_lain","t_tagihan","t_bkm_non_order","t_spk_lain"];
    public $detailsChild= [];
    public $detailsHeirs= ["t_surat_jalan","t_spk_angkutan","t_spk_angkutan","t_nota_rampung_d","t_spk_lain"];
    public $unique      = [];
    public $required    = [""];
