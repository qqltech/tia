...
{   
    ...
    protected $fillable = ["t_nota_rampung_id","no_kontainer","ukuran","jenis","sektor","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","t_buku_order_d_npwp_id","lolo","m2","ow","m3","m4","m5","plg_mon","ge","strp_stuf","canc_doc","closing_container","batal_muat","spek_kont","vgm","mob","denda_koreksi","materai","by_adm_nr","nr","denda_sp","behandle"];
    ...
    public $columnsFull = ["id:bigint","t_nota_rampung_id:integer","no_kontainer:string:30","ukuran:integer","jenis:integer","sektor:integer","catatan:text","creator_id:integer","last_editor_id:integer","edited_at:datetime","deletor_id:integer","deleted_at:datetime","created_at:datetime","updated_at:datetime","t_buku_order_d_npwp_id:integer","lolo:decimal","m2:decimal","ow:decimal","m3:decimal","m4:decimal","m5:decimal","plg_mon:decimal","ge:decimal","strp_stuf:decimal","canc_doc:decimal","closing_container:decimal","batal_muat:decimal","spek_kont:string:100","vgm:decimal","mob:decimal","denda_koreksi:decimal","materai:decimal","by_adm_nr:decimal","nr:string:191","denda_sp:decimal","behandle:decimal"];
    public $rules       = [];
    ...
    public $createable  = ["t_nota_rampung_id","no_kontainer","ukuran","jenis","sektor","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","t_buku_order_d_npwp_id","lolo","m2","ow","m3","m4","m5","plg_mon","ge","strp_stuf","canc_doc","closing_container","batal_muat","spek_kont","vgm","mob","denda_koreksi","materai","by_adm_nr","nr","denda_sp","behandle"];
    public $updateable  = ["t_nota_rampung_id","no_kontainer","ukuran","jenis","sektor","catatan","creator_id","last_editor_id","edited_at","deletor_id","deleted_at","t_buku_order_d_npwp_id","lolo","m2","ow","m3","m4","m5","plg_mon","ge","strp_stuf","canc_doc","closing_container","batal_muat","spek_kont","vgm","mob","denda_koreksi","materai","by_adm_nr","nr","denda_sp","behandle"];
