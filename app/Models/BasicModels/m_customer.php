...
{   
    ...
    public $heirs       = ["t_ppjk","t_asset_disposal","t_buku_order_d_aju","t_buku_order","t_komisi","t_tagihan","m_tarif","t_credit_note","t_spk_angkutan","t_spk_angkutan","t_pembayaran_piutang","t_debit_note","m_tarif_komisi","m_tarif_komisi_undername","t_komisi_undername","t_dp_penjualan"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
