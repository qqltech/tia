...
{   
    ...
    public $heirs       = ["m_tarif_komisi","m_tarif","t_spk_angkutan","t_spk_angkutan","t_spk_lain","t_buku_order","t_komisi","temp_t_spk_angkutan","temp_t_spk_angkutan","t_pembayaran_piutang","t_komisi_undername","t_ppjk","t_tagihan","t_tagihan_lain_lain","t_debit_note","m_tarif_komisi_undername","t_buku_order_d_aju","t_dp_penjualan","t_credit_note","t_asset_disposal"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
