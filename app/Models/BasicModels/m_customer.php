...
{   
    ...
    public $heirs       = ["t_ppjk","t_asset_disposal","t_buku_order_d_aju","t_buku_order","t_komisi","t_tagihan","m_tarif","t_credit_note","t_pembayaran_piutang","t_debit_note","m_tarif_komisi","m_tarif_komisi_undername","t_komisi_undername","t_dp_penjualan"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
    public $required    = ["m_customer_group_id","kota","kodepos","taxable","is_active","jenis_perusahaan","nama_perusahaan","kecamatan","top","tolerance"];
