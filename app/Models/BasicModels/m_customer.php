...
{   
    ...
    public $heirs       = ["m_tarif","m_tarif_komisi","m_tarif_komisi_undername","t_buku_order_d_aju","t_buku_order","t_debit_note","t_dp_penjualan","t_credit_note","t_komisi","t_komisi_undername","t_pembayaran_piutang","t_ppjk","t_tagihan","t_spk_angkutan","t_spk_angkutan","t_spk_lain","t_asset_disposal","t_tagihan_lain_lain"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
