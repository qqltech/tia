...
{   
    ...
    public $rules       = [];
    public $joins       = ["set.m_general.id=set.m_kary.bank_id","m_coa.id=set.m_kary.piutang_id"];
    public $details     = [];
    public $heirs       = ["default_users","t_dinas_luar","t_buku_order_d_npwp","t_buku_order_d_npwp","t_spk_angkutan","t_bon_dinas_luar","t_confirm_asset"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
