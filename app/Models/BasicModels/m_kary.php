...
{   
    ...
    public $details     = [];
    public $heirs       = ["t_bon_spk_lain","default_users","t_dinas_luar","temp_t_spk_angkutan","t_buku_order_d_npwp","t_buku_order_d_npwp","t_spk_angkutan","t_bon_dinas_luar","t_confirm_asset"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
