...
{   
    ...
    public $details     = [];
    public $heirs       = ["default_users","t_bon_dinas_luar","t_spk_angkutan","t_confirm_asset","temp_t_spk_angkutan","t_internal","t_buku_order_d_npwp","t_buku_order_d_npwp","t_dinas_luar","t_bon_spk_lain"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
