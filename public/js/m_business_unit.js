...
// ENDPOINT API
const endpointApi = 'm_business_unit'
onBeforeMount(() => {
    document.title = 'Master Business Unit'
})
...
const table = reactive({
    api: {
        ...
        params: {
            simplest: true,
            searchfield: 'this.kode, this.alamat, this.nama, this.npwp, this.kota',
        },
        onsuccess(response) {
    ...
    columns: [
        ...
        {
            headerName: 'Kode', field: 'kode', flex: 1, cellClass: ['border-r', '!border-gray-200', 'justify-start'],
            sortable: true, filter: 'ColFilter'
        },
        {
            headerName: 'Nama', field: 'nama', flex: 2, cellClass: ['border-r', '!border-gray-200', 'justify-start'],
            sortable: true, filter: 'ColFilter'
        },
        {
        ...
        {
            headerName: 'NPWP', field: 'npwp', flex: 1, cellClass: ['border-r', '!border-gray-200', 'justify-start'],
            sortable: true, filter: 'ColFilter'
        },
        {
            headerName: 'Kota', field: 'kota', flex: 1, cellClass: ['border-r', '!border-gray-200', 'justify-start'],
            sortable: true, filter: 'ColFilter'
        },
        {
