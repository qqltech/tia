...
import { computed, ref, readonly, reactive, inject, onMounted, onBeforeMount, watchEffect, onActivated, watch } from 'vue'
...
let values = reactive({
  is_active: true,
  tipe: tipe.value,
  tipe: tipe.value === 'TIA' ? 'TIA' : tipe.value === 'SUT' ? 'SUT' : ''
})
