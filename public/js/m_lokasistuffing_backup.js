...
// ENDPOINT API
const endpointApi = 'm_lokasistuffing'
onBeforeMount(() => {
...
const table = reactive({
    api: {
        ...
        params: {
            simplest: true,
            searchfield: 'this.kode_jasa, this.kode, this.nama_jasa, this.alamat, this.catatan, this.satuan',
        },
        onsuccess(response) {
    ...
    columns: [
        ...
        {
            headerName: 'Kode', field: 'kode_lokasi', flex: 1, cellClass: ['border-r', '!border-gray-200', 'justify-start'],
            sortable: true, filter: 'ColFilter'
        },
        {
            headerName: 'Nama', field: 'nama_lokasi', flex: 1, cellClass: ['border-r', '!border-gray-200', 'justify-start'],
            sortable: true, filter: 'ColFilter'
        },
        {
