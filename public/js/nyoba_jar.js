...
function changeParent (){
  if(isRead){
    if(values.is_parent === false){
      ...
      //   values.nomor = initialValues.nomor?.replace(initialValues['values.no_induk'],"")
      //   values.tempNomor = initialValues.nomor?.replace(initialValues['values.no_induk'],"")
      // }
    }
  }
}
...
onBeforeMount(async () => {
  if (isRead) {
    ...
    try {
      ...
      initialValues.level = initialValues['level']
      if(initialValues.induk){
        nilaiAwal.value = initialValues.nomor
        initialValues.nomor_awal = initialValues.nomor
        initialValues.nomor = initialValues.nomor?.replace(initialValues['values.no_induk'],"")
      }
      ...
      if(initialValues['values.no_induk']){
        initialValues.nomorParent = initialValues['values.no_induk']
      }
