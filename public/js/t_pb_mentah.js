...
// ------------------------------ PERSIAPAN
// SESUAIKAN ENDPOINT PADA BE 
const endpointApi = 'm_gen'
onBeforeMount(()=>{
  document.title = 'Transaksi Pembelian Bahan Mentah '
})


//  @if( $id )------------------- JS CONTENT ! PENTING JANGAN DIHAPUS
// INI UNTUK NGODING DI DALAM FORM


// TAB FUNGSI
const activeTab = ref(1); // Default tab adalah "Kelinci"
...
//  @else----------------------- LANDING
//  HALAMAN LANDIG LOGIC JS DISINI . 
