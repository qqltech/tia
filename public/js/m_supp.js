...
onBeforeMount(async () => {
  ...
  if (isRead) {
    ...
    try {
      ...
      if (actionText.value?.toLowerCase() === 'copy' && initialValues.kode) {
...
const landing = reactive({
  ...
  api: {
    ...
    params: {
      simplest: true,
      searchfield: 'this.kode,this.is_active,this.nama,this.alamat,this.no_telp1,this.negara,this.kota,jenis.deskripsi'
    },
    onsuccess(response) {
