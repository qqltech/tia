...
function addRow() {
  values.m_product_det_photo.push({})
}

function deleteRow(idx){
  values.m_product_det_photo.splice(idx,1)
}
...
const landing = reactive({
  ...
  {
    headerName:'Diskon Member %',
    field: 'discount_member_pctg',
    filter: true,
    sortable: true,
    flex:1,
    filter: 'ColFilter',
  ...
  {
    headerName:'Diskon Premium %',
    field: 'discount_premium_pctg',
    filter: true,
    sortable: true,
    flex:1,
    filter: 'ColFilter',
