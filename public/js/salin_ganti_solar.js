...
async function solar(t_spk_angkutan_id) {
  ...
  if (t_spk_angkutan_id && t_spk_angkutan_id.id) {
    values.tipe = t_spk_angkutan_id.tipe_spk || ''; 
    values.no_container_1 = `${t_spk_angkutan_id['t_detail_npwp_container_1.no_prefix'] || ''} - ${t_spk_angkutan_id['t_detail_npwp_container_1.no_suffix'] || ''}`;
    values.no_container_2 = `${t_spk_angkutan_id['t_detail_npwp_container_2.no_prefix'] || ''} - ${t_spk_angkutan_id['t_detail_npwp_container_2.no_suffix'] || ''}`;
    values.supir = t_spk_angkutan_id.supir || ''; 
    values.dari = t_spk_angkutan_id.dari || ''; 
    values.ke = t_spk_angkutan_id.ke || ''; 
    values.sektor = t_spk_angkutan_id.sektor1 || ''; 
    values.sangu = t_spk_angkutan_id.sangu || 0; 
    values.premi = t_spk_angkutan_id.premi || 0; 
    values.catatan = t_spk_angkutan_id.catatan || 'Tidak Ada Catatan'; 
  } else {
    values.tipe = null;
...
watchEffect(() => {
  values.nominal = values.premi - values.sangu;
});
