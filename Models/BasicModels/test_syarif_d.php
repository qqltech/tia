...
class test_syarif_d extends Model
{   
    use ModelTrait;

    protected $table    = 'test_syarif_d';
    ...
    public $rules       = [];
    public $joins       = ["test_syarif.id=test_syarif_d.id_barang"];
    public $details     = [];
    public $heirs       = [];
    public $detailsChild= [];
    public $detailsHeirs= [];
    ...
    {
        return $this->belongsTo('App\Models\BasicModels\test_syarif', 'id_barang', 'id');
    }
}
