...
<div class="md:w-full pb-4">
  <div class="flex flex-col rounded-md shadow-md md:w-full bg-white">
    ...
    <div class="pt-2 pb-10 px-4 grid grid-cols-3 gap-y-2 gap-x-4 sticky">
      <FieldSelect class="pt-1" :bind="{ disabled: !actionText, clearable:false }" :value="data.bu_id"
        @input="v=>data.bu_id=v" @update:valueFull="(dt)=>{	
          data.nip = dt.kode	
        }" :errorText="formErrors.bu_id?'failed':''" :hints="formErrors.bu_id" valueField="id" displayField="nama"
        :api="{
