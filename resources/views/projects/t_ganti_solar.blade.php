...
<div class="bg-white p-1 rounded-md min-h-[520px] border-t-10 border-blue-500">
  <div class="pl-4 pt-2 pb-2">
    <h1 class="text-xl font-semibold">GANTI SOLAR</h1>
  </div>
...
<div class="flex flex-col border rounded-md shadow-md md:w-full w-full p-0 bg-white border-none">
  ...
  <div class="grid <md:grid-cols-1 grid-cols-3 grid-flow-row p-4 gap-3">
    ...
    <div class="w-full !mt-3">
      <FieldNumber type="number" class="w-full !mt-3" :bind="{ disabled: true, clearable:true  ,readonly:true}" :value="values.premi"
        @input="v=>values.premi=v" :errorText="formErrors.premi?'failed':''" :hints="formErrors.premi"
        placeholder="Premi" label="Premi" :check="false" />
    </div>
    
    <div class="w-full !mt-3">
      <FieldNumber type="number" class="w-full !mt-3" :bind="{ disabled: true, clearable:true  ,readonly:true}" :value="values.sangu"
        @input="v=>values.sangu=v" :errorText="formErrors.sangu?'failed':''" :hints="formErrors.sangu"
        placeholder="Sangu" label="Sangu" :check="false" />
    </div>
    <div class="w-full !mt-3">
      <FieldNumber type="number" class="w-full !mt-3" :bind="{ disabled: !actionText, clearable:true  ,readonly:!actionText}" :value="values.nominal"
