  ...
  <div class="flex flex-col border rounded-md shadow-md md:w-full w-full p-0 bg-white border-none">
    <div class="bg-blue-500 text-white rounded-t-md py-2 px-4">
      <div class="flex items-center">
        ...
        <div>
          <h1 class="text-20px font-bold">Form Bank</h1>
          <p class="text-gray-100">Untuk mengatur informasi Bank pada sistem</p>
        </div>
      </div>
    </div>
      <!-- HEADER END -->
      ...
      <div class="grid <md:grid-cols-1 grid-cols-3 grid-flow-row p-4 gap-3">
        ...
        <div class="w-full !mt-3">
          <FieldX
            ...
            :hints="formErrors.deskripsi" 
            label="bank"
            placeholder="Tuliskna Nama Bank" :check="false"
          />
        </div>
