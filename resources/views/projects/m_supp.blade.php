...
<div v-show="values.negara === 'Indonesia'">
  <FieldSelect 
    :bind="{ disabled: (!values.provinsi) || !actionText , clearable: false  }" 
    class="w-full !mt-3" 
    :value="values.kota" 
...
<div v-show="values.negara === 'Indonesia'">
  <FieldSelect 
    :bind="{ disabled: (!values.kota) || !actionText , clearable: false  }" 
    class="w-full !mt-3" 
  ...
  />
        ...
        <div>
            <FieldX :bind="{ readonly: !actionText }" class="w-full  !mt-3" :value="values.catatan"
              ...
              :check="false" type="textarea" label="Catatan" placeholder="Tuliskan Catatan" />
          </div>
