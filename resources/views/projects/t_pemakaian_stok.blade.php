  ...
  <div class="p-4 grid <md:grid-cols-1 grid-cols-3 gap-2 ">
    ...
    <div>
      <FieldSelect :bind="{ disabled: true }" class="w-full !mt-3 " :value="values.no_pemakaian_stok"
        ...
        :hints="formErrors.no_pemakaian_stok" label="No. Pemakaian Stok" placeholder="No. Pemakaian Stok"
        :check="false" />
    </div>
    ...
    <div>
      <FieldX :bind="{ disabled: true, readonly:true }" class="w-full !mt-3 " :value="values.tanggal"
        ...
        label="Tanggal" placeholder="Tanggal" :check="false" type="date" />
    </div>
          ...
          authorization: `${store.user.token_type} ${store.user.token}`
            ...
            onsuccess: (response) => {
              response.data = [...response.data].map((dt) => {
                return {
                  t_pemakaian_stok_id: values.id || null,
                  m_item_id: dt.id,
                  kode: dt.kode,
      ...
      <table class="w-full overflow-x-auto table-auto border border-[#CACACA] mt-4">
        ...
        <tbody>
          <tr v-for="(item, i) in detailArr" :key="item.id" class="border-t" v-if="detailArr.length > 0">
            ...
            <td class="p-2 border border-[#CACACA]">
              <FieldNumber :bind="{ readonly: !actionText }" class="m-0" :value="detailArr[i].usage"
                :errorText="formErrors.usage?'failed':''" @input="v=>detailArr[i].usage=v" :hints="formErrors.usage"
                :check="false" />
            </td>
            <td class="p-2 border border-[#CACACA]">
