...
$nospk = \DB::select("SELECT tsj.*, tsj.depo as depo_tsj, UPPER(mg3.deskripsi) as jenis_sj_deskripsi, tbo.*, mc.*, tbodn.*,  mg2.deskripsi as deskripsi_jenis, mg2.deskripsi2 as singkatan_jenis
