...
$temp = ' sebelas';
  ...
  <div class="container" style="font-size: 6px; border: 0.5px solid black;">
    <table>
      <tr>
        ...
        <td colspan="3" style="border: 0.5px solid black; ">
          <table>
            ...
            <tr>
              ...
              <td style="width: 20%;">
                <div style="border: none; border-bottom: 0.5px dashed black;">{{{$n->supir_nama}}}</div>
              </td>
            </tr>
            <tr>
        ...
        <td colspan="3" style="border-left: 0.5px solid black; border-right: 0.5px solid black;">
          <table>
            <tr>
              ...
              <td style="width: 26.72%; border-right: 0.5px solid black; text-align: center; line-height: 10px;">
                {{$n->customer_nama_perusahaan}}
              </td>
              <td style="width: 26.1%; border-right: 0.5px solid black;">
                <table>
