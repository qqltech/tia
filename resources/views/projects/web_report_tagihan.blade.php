...
<table>
  <tr>
    ...
    <td style="padding: 10px; width: 30%; font-weight: bold;">
      PT.TIA SENTOSA MAKMUR
    </td>
  </tr>
  <tr>
    <td style="text-align: left; font-weight: bold;">  Surabaya</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td td style="text-align: left; padding: 10px; width: 10% ; ">
      VOY
    </td>
...
<table>
  <tr>
    <td style="width:2%;">-</td>
    <td style="width:60%;">Total Jasa Cont + PPJK</td>
    <!-- UANG -->
  ...
  <tr>
    <td style="width:2%;">-</td>
    <td style="width:60%;">Total Lain-lain (PPN)</td>
    <td></td>
    <td></td>
  </tr>
  @foreach ($generate_total as $gt)
    @if(!is_null($gt->is_ppn)) <!-- Pastikan hanya menampilkan data dengan is_ppn TRUE -->
            ...
            <tr>
                ...
                <td colspan="3">
                    <table style="width:100%;">
                        <tr> 
                            <td style="width:2%;">&#8226;</td>
                            <td style="width:62%;">{{ $gt->keterangan_lain }}</td>
                            <td style="width:5.5%;">Rp.</td>
                            <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:30.5%; text-align: right;">
...
@endforeach
  ...
  <tr>
      <td style="width:2%;">-</td>
      <td style="width:60%; font-weight: bold;">Jumlah</td>
      <td style="width:5%;">Rp.</td>
      <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:28%; text-align: right;">
  ...
  <tr>
    <td style="width:2%;">-</td>
    <td style="width:60%; font-weight: bold;">PPN</td>
    <td style="width:5%;">Rp.</td>
    <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:28%; text-align: right;">
...
<table border="1" cellspacing="0" cellpadding="10" style="font-size: 10px; width: 80%; border-collapse: collapse;">
  ...
  @foreach($generate_total as $gt)
    @if(is_null($gt->is_ppn)) <!-- Pastikan is_ppn bernilai NULL -->
        @unless(in_array($gt->keterangan_lain, $shown_items)) <!-- Cek apakah sudah pernah ditampilkan -->
            @php
            ...
            <tr>
                <td style="text-align: left;">
                    {{ $gt->keterangan_lain }} <!-- Menampilkan keterangan_lain atau teks jika NULL -->
                </td>
...
<table cellpadding="3">
  <tr>
    <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:50.5%; text-align: right; font-weight: Bold;" > TOTAL RP. 
    </td>
    <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:29.5%; text-align: right; font-weight: Bold;">
...
<table cellpadding="3">
  <tr> <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:50.5%; text-align: right; font-weight: Bold;" >  Uang Muka Tanggal RP. 
    </td>
    <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:29.5%; text-align: right; font-weight: Bold;"> {{ number_format($dt->total_amount, 2, ',', '.') }}
  </td>
  </tr>
</table>
...
<table cellpadding="3">
  ...
  @endphp
  <tr> <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:50.5%; text-align: right; font-weight: Bold;" >  KURANG - BAYAR RP. 
    </td>
    <td style="border-style: solid; border-width: 0px 1px 1px 1px; width:29.5%; text-align: right; font-weight: Bold;">{{ number_format($kurang_bayar, 2, ',', '.') }}</td>
