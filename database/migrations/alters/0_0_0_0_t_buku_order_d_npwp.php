...
class tbukuorderdnpwp extends Migration
{
    ...
    public function up()
    {
        Schema::table($this->tableName, function (Blueprint $table) {
            ...
            // $table->string('no_prefix', 20)->nullable()->change();
            // $table->string('no_suffix', 20)->nullable()->change();
            // $table->integer('ukuran')->comment('{"src":"set.m_general.id"}')->nullable()->change();
            // $table->integer('tipe')->comment('{"src":"set.m_general.id"}')->nullable()->change();
