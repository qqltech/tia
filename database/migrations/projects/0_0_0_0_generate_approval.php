...
class generateapproval extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->bigInteger('m_approval_id')->comment('{"src":"set.m_approval.id"}')->nullable();
            ...
            $table->bigInteger('last_approve_det_id')->comment('{"src":"set.generate_approval_det.id"}')->nullable();
