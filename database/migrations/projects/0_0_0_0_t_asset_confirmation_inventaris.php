...
class tassetconfirmationinventaris extends Migration
{
    protected $tableName = "t_asset_confirmation_inventaris";
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->bigInteger('jenis_inventaris_id')->comment('{"src": "set.m_general.id"}');
